...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create favorite' do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { computer_id: @favorite.computer_id, user_id: @favorite.user_id } },
                          as: :json
    end
  ...
  test 'should update favorite' do
    patch favorite_url(@favorite),
          params: { favorite: { computer_id: @favorite.computer_id, user_id: @favorite.user_id } }, as: :json
    assert_response 200
  end
